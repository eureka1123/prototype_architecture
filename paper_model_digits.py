...
class Prototype(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # print(prototypes_difs.shape)
        # prototype_difs = [transform_input, i.repeat(batch_size,1)) for i in self.prototypes]
        # prototype_difs = torch.mean(torch.stack(prototype_difs).transpose(0,1),dim=2)
